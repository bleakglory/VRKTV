...
public class WAVFile
{
    ...
    public class WAVFileException : Exception
    {
        ...
        public WAVFileException(string message,string position):base(message)
        {
    ...
    {
        public WAVFileReadException(string message, string position) : base(message,position) { }
    }
    public class WAVFileWriteException : WAVFileException
    {
        public WAVFileWriteException(string message,string position) : base(message, position) { }
    }
    public class WAVFileSampleRateException : WAVFileException
    {
        public WAVFileSampleRateException(string message,string position,int samplerate) : base(message, position)
        {
    ...
    {
        public WAVFileBitsPerSampleException(string message, string position, short bitspersample) : base(message, position)
        {
    ...
    {
        public WAVFileAudioMergeException(string message,string position) : base(message, position)
        {
    ...
    {
        public WAVFileIOException(string message,string position) : base(message, position)
        {
    ...
    /// <summary>
    /// iterating the operation mode of file(read, write , read and write)
    /// </summary>
    ...
    /// <summary>
    /// Parsing and ensuring closing the file
    /// </summary>
    ~WAVFile()
    {
        Close();
